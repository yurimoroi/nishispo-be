...
class UserEditRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $isAdminRoute = $this->route()->getName() === 'admin.edit.users';
        ...
        return [
            ...
            'login_id' => [
                ...
                'string',
                'max:100',
                Rule::unique('users', 'login_id')->ignore($isAdminRoute ? $this->id : $this->user()->id,'id'),
            ],
            'email' => [
                'required',
                'string',
                'email',
                'max:255',
                Rule::unique('users', 'email')->ignore($isAdminRoute ? $this->id : $this->user()->id,'id'),
            ],
            ...
            'affiliate_id' => 'nullable|array',
            'affiliate_id.*' => 'string|exists:organizations,id',
    ...
    public function messages()
    {
        return [
            ...
            "advertiser_flg.boolean" => __("advertiser_flg"),
